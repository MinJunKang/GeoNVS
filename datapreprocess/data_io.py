...
class ReconfusionParser(BaseParser):
    def __init__(self, data_dir: str, normalize: bool = False, file_name: str = "transforms.json"):
        ...
        with open(osp.join(data_dir, file_name)) as f:
        ...
        for frame in metadata["frames"]:
            if frame["file_path"] is None:
                ...
                image_path = osp.join(data_dir, file_path)
        ...
        camtoworlds[:, :, [1, 2]] *= -1  # convert openGL to openCV
