...
def get_parser():
    ...
    ## diffusion
    parser.add_argument("--ckpt_path", type=str, default='pretrained_weights/model.ckpt', help="checkpoint path")
    ...
    ## dust3r
    parser.add_argument('--model_path', type=str, default='pretrained_weights/DUSt3R_ViTLarge_BaseDecoder_512_dpt.pth', help='The path of the model')
