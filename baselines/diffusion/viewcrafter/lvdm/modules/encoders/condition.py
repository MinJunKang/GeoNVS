...
from baselines.diffusion.viewcrafter.lvdm.common import autocast
from baselines.diffusion.viewcrafter.utils.diffusion_utils import count_params
...
class FrozenOpenCLIPImageEmbedderV2(AbstractEncoder):
    ...
    def encode_with_vision_transformer(self, x):
        ...
        # open_clip >= 2.26 dropped `input_patchnorm`; absent means the standard
        # (non dual-patchnorm) path below.
