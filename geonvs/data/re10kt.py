...
class Re10KODataset(Dataset):
    ...
    def __init__(self, root_dir, stage, num_images, target_shape, step_tracker, plucker_convention='seva', square_crop=True):
        ...
        self.near = 0.5
        self.far = 100.0
        self.num_context_views = 4  # number of context views
        self.num_total_views = num_images  # total number of views
    ...
    def __getitem__(self, idx):
        ...
        mask_valid = (get_fov(intrinsics).rad2deg() < self.max_fov).any(dim=1)
