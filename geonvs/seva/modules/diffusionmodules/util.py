...
def pose_cdistance(reference_pose, measurement_pose):
    """
    :param reference_pose: BxNx4x4 torch array, reference frame camera-to-world pose (not extrinsic matrix!)
    :param measurement_pose: BxMx4x4 torch array, measurement frame camera-to-world pose (not extrinsic matrix!)
    ...
    """
    rel_pose = torch.einsum('bnij,bmjk->bnmik', torch.linalg.inv(reference_pose), measurement_pose)
    R = rel_pose[..., :3, :3]
    t = rel_pose[..., :3, 3]
