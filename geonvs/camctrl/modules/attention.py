...
from diffusers.models.attention import _chunked_feed_forward, FeedForward, Attention
from diffusers.utils.torch_utils import maybe_allow_in_graph


@maybe_allow_in_graph
class Attention_(Attention):
    # overwrite the forward function to add pose feature
    def forward(
        self,
